...
class homePetCareScreen extends StatelessWidget {
  homePetCareScreen({super.key});
      ...
      child: GetBuilder<MainController>(
        builder: (mController) => Scaffold(
            ...
            bottomNavigationBar: Container(
                color: kPrimaryColor, height: 90, child: petCareBottomNav()),
            body: _mainController.pagePetCareContainer),
      ),
    );
  }
}
