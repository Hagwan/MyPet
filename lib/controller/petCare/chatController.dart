...
import 'package:pets/view/petCare/chat/details.dart';
...
class ChatController extends GetxController {
  ...
  void onInit() {
    ...
    userPetCareID = storageInfo.read(userPetCareId);
  ...
  getChats() async {
    ...
    QuerySnapshot messageListQuerySnapshot = await messageList
        .where('admin', isEqualTo: userPetCareID)
  ...
  Future<void> getContactData() async {
    ...
    QuerySnapshot messageListQuerySnapshot =
        await messageList.where('admin', isEqualTo: userPetCareID).get();
